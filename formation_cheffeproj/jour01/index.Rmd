...
subtitle: "Jour 1 : construire un discours"
...
Deux arrêtés fixent les modalités de publication des données essentielles de la commande publiques (DECP) :
...
## 4.1 L'open data, ça sert à quoi ?
...
# 5. Construisons un argumentaire !
...
### Rendez-vous la semaine prochaine et d'ici là, n'hésitez pas à vous entraîner !
